// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.1.0-39.0.dev.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    getCollatorECMA(locales, localeMatcher) {
      ...
      o.localeMatcher = t1;
      supportedLocales = A.List_List$from(self.Intl.Collator.supportedLocalesOf(A.localeToJs(locales), o), type$.String);
    ...
    getDatetimeFormatterECMA(locales, localeMatcher) {
      ...
      if (t1 == null)
        t1 = localeMatcher._name;
      o.localeMatcher = t1;
      return A.List_List$from(self.Intl.DateTimeFormat.supportedLocalesOf(A.localeToJs(locales), o), type$.String).length !== 0 ? new A._DatetimeFormatECMA() : null;
    },
    ...
    getListFormatterECMA(locales, localeMatcher) {
      ...
      if (t1 == null)
        t1 = localeMatcher._name;
      o.localeMatcher = t1;
      return A.List_List$from(self.Intl.ListFormat.supportedLocalesOf(A.localeToJs(locales), o), type$.String).length !== 0 ? new A.ListFormat() : null;
    },
    ...
    getNumberFormatterECMA(locales, localeMatcher) {
      ...
      if (t1 == null)
        t1 = localeMatcher._name;
      o.localeMatcher = t1;
      return A.List_List$from(self.Intl.NumberFormat.supportedLocalesOf(A.localeToJs(locales), o), type$.String).length !== 0 ? new A.NumberFormat() : null;
    },
    ...
    TestTypes: function TestTypes(t0) {
      this._name = t0;
    },
  ...
  A._Utf8Decoder.prototype = {
    convertGeneral$4(codeUnits, start, maybeEnd, single) {
      ...
      type$.List_int._as(codeUnits);
      end = A.RangeError_checkValidRange(start, maybeEnd, codeUnits.get$length(codeUnits));
      if (start === end)
        return "";
  ...
  A.Collation.prototype = {
    compare$2(_, a, b) {
      ...
      if (A.isInTest()) {
        ...
        return this._collationImpl.compareImpl$8$caseFirst$collation$ignorePunctuation$numeric$sensitivity$usage(a, b, null, null, false, false, null, B.Usage_1);
    }
  };
  ...
  A.CollationECMA.prototype = {
    compareImpl$8$caseFirst$collation$ignorePunctuation$numeric$sensitivity$usage(a, b, caseFirst, collation, ignorePunctuation, numeric, sensitivity, usage) {
      ...
      o.localeMatcher = t1;
      o.usage = usage._name;
      o.ignorePunctuation = false;
      o.numeric = false;
      return J.compare$2$x(new self.Intl.Collator(A.localeToJs(this.locales), o), a, b);
    }
  };
  A.Usage.prototype = {
    _enumToString$0() {
  ...
  A.TestTypes.prototype = {
    _enumToString$0() {
      return "TestTypes." + this._name;
    }
  };
  A.main_closure.prototype = {
    call$1($event) {
      var line, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, _i, t11, exception, t12, result;
      type$.List_int._as($event);
      for (t1 = B.Utf8Decoder_false.convert$1($event).split("\n"), t2 = t1.length, t3 = type$.String, t4 = type$.dynamic, t5 = type$.List_String, t6 = type$.NumberFormat, t7 = type$.DatetimeFormat, t8 = type$.ListFormat, t9 = type$.Collation, t10 = type$.Map_String_dynamic, _i = 0; _i < t2; ++_i) {
        t11 = {};
        line = t1[_i];
        if (J.$eq$(line, "#EXIT"))
          A._ProcessUtils__exit(0);
        else if (J.$eq$(line, "#VERSION")) {
          t11 = $.$get$Platform__version();
          A.printString(B.C_JsonCodec.encode$1(A.LinkedHashMap_LinkedHashMap$_literal(["icuVersion", "71.1", "platform", "Dart", "platformVersion", t11.substring$2(t11, 0, t11.indexOf$1(t11, " "))], t3, t3)));
        } else if (J.$eq$(line, "#TESTS"))
          A.printString(B.C_JsonCodec.encode$1($.supportedTests));
        else {
          t11.decoded = null;
          try {
            t11.decoded = t10._as(B.C_JsonCodec.decode$1(line));
          } catch (exception) {
            t1 = A.S(line);
            A.printString("ERROR " + t1);
            throw exception;
          }
          switch (B.JSArray_methods.firstWhere$1(B.List_aEs, new A.main__closure(t11))) {
            case B.TestTypes_0:
              t12 = t11.decoded;
              t5._as(B.List_en);
              A.buildFormatter(B.List_en, B.LocaleMatcher_null_lookup, B.C_AlwaysEcma, A.number_format_ecma__getNumberFormatterECMA$closure(), A.number_format_4x__getNumberFormatter4X$closure(), t6);
              A.buildFormatter(B.List_en, B.LocaleMatcher_null_lookup, B.C_AlwaysEcma, A.datetime_format_ecma__getDatetimeFormatterECMA$closure(), A.datetime_format_4x__getDatetimeFormatter4X$closure(), t7);
              A.buildFormatter(B.List_en, B.LocaleMatcher_null_lookup, B.C_AlwaysEcma, A.list_format_ecma__getListFormatterECMA$closure(), A.list_format_4x__getListFormatter4X$closure(), t8);
              result = A.buildFormatter(B.List_en, B.LocaleMatcher_null_lookup, B.C_AlwaysEcma, A.collation_ecma__getCollatorECMA$closure(), A.collation_4x__getCollator4X$closure(), t9).compare$2(0, A._asString(t12.$index(0, "string1")), A._asString(t12.$index(0, "string2"))) <= 0 && true;
              break;
            case B.TestTypes_1:
            case B.TestTypes_2:
            case B.TestTypes_3:
            ...
            case B.TestTypes_5:
            default:
              throw A.wrapException(A.UnsupportedError$(""));
          }
          A.printString(B.C_JsonCodec.encode$1(A.LinkedHashMap_LinkedHashMap$_literal(["label", t11.decoded.$index(0, "label"), "result", result], t3, t4)));
        }
      }
    },
    $signature: 6
  ...
  A.main__closure.prototype = {
    call$1(element) {
      return type$.TestTypes._as(element)._name === this._box_0.decoded.$index(0, "test_type");
    },
    $signature: 7
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "collation_4x__getCollator4X$closure", "getCollator4X", 8);
    _static_2(A, "collation_ecma__getCollatorECMA$closure", "getCollatorECMA", 9);
    _static_1(A, "datetime_format_4x__getDatetimeFormatter4X$closure", "getDatetimeFormatter4X", 10);
    _static_2(A, "datetime_format_ecma__getDatetimeFormatterECMA$closure", "getDatetimeFormatterECMA", 11);
    _static_2(A, "list_format_ecma__getListFormatterECMA$closure", "getListFormatterECMA", 12);
    _static_2(A, "number_format_ecma__getNumberFormatterECMA$closure", "getNumberFormatterECMA", 13);
    _static_1(A, "list_format_4x__getListFormatter4X$closure", "getListFormatter4X", 14);
    _static_1(A, "number_format_4x__getNumberFormatter4X$closure", "getNumberFormatter4X", 15);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.localeToJs_closure, A.main_closure, A.main__closure]);
    ...
    _inheritMany(A._Enum, [A.Usage, A.LocaleMatcher, A.TestTypes]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["@(@)", "~(Object?,Object?)", "@()", "@(@,String)", "@(String)", "String(String)", "~(List<int>)", "bool(TestTypes)", "Collation(List<String>)", "Collation?(List<String>,LocaleMatcher)", "DatetimeFormat(List<String>)", "DatetimeFormat?(List<String>,LocaleMatcher)", "ListFormat?(List<String>,LocaleMatcher)", "NumberFormat?(List<String>,LocaleMatcher)", "ListFormat(List<String>)", "NumberFormat(List<String>)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","CollatorJS":"LegacyJavaScriptObject","DateJS":"LegacyJavaScriptObject","DatetimeFormatJS":"LegacyJavaScriptObject","ListFormatJS":"LegacyJavaScriptObject","_NumberFormatJS":"LegacyJavaScriptObject","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfInt":{"ListBase":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeUint8List":{"ListBase":["int"],"Uint8List":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"MapBase":{"Map":["1","2"]},"_JsonMap":{"MapBase":["String","@"],"Map":["String","@"],"MapBase.K":"String","MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"JsonCodec":{"Codec":["Object?","String"]},"int":{"num":[]},"List":{"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"StringBuffer":{"StringSink":[]},"Collation4X":{"CollationImpl":[]},"CollationECMA":{"CollationImpl":[]},"DatetimeFormat4X":{"DatetimeFormat":[]},"_DatetimeFormatECMA":{"DatetimeFormat":[]},"AlwaysEcma":{"EcmaPolicy":[]},"Uint8List":{"List":["int"],"Iterable":["int"]}}'));
...
;
    ...
    B.TestTypes_0 = new A.TestTypes("coll_shift_short");
    B.TestTypes_1 = new A.TestTypes("decimal_fmt");
    B.TestTypes_2 = new A.TestTypes("datetime_fmt");
    B.TestTypes_3 = new A.TestTypes("display_names");
    B.TestTypes_4 = new A.TestTypes("lang_names");
    B.TestTypes_5 = new A.TestTypes("number_fmt");
    B.List_aEs = A._setArrayType(makeConstList([B.TestTypes_0, B.TestTypes_1, B.TestTypes_2, B.TestTypes_3, B.TestTypes_4, B.TestTypes_5]), A.findType("JSArray<TestTypes>"));
  ...
  (function staticFields() {
    ...
    $.supportedTests = A.LinkedHashMap_LinkedHashMap$_literal(["supported_tests", A._setArrayType(["coll_shift_short", "decimal_fmt", "number_fmt", "display_names", "language_display_name"], type$.JSArray_String)], type$.String, type$.List_String);
  })();
  (function lazyInitializers() {
    ...
    _lazyFinal($, "Platform__version", "$get$Platform__version", () => A._Platform_version());
